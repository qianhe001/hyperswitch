 ...
 */
func (request *Request) CreatePayment3DChallengeRequest() {
	date := time.Now().UTC()
	...
	data := map[string]interface{}{
		...
		"currency":        "HKD",
		"descriptor":      "付款",
		"merchantOrderId": date.Format("20060102150405") + fmt.Sprintf("%06d", date.UnixNano()/1000%1000000),
		"requestId":       date.Format("20060102150405") + fmt.Sprintf("%06d", date.UnixNano()/1000%1000000),
